    ...
    <% if(items.length){ %>
        ...
        <div class="attributes">
            <label class="custom-block">
                <input type="checkbox" name="extras[]" id="resource-<%= item.resource_slug %>" value="<%= item.id %>" class="booking-extra" <% if( selectedItems && selectedItems.includes(item.resource_slug)){ %> checked <% } %>>
