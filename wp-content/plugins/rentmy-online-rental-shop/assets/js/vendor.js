...
//product details page slider starts
/*-- active view image js --*/
jQuery(document).ready(function () {
    jQuery('.product-view-area ul li a').click(function () {
        jQuery('li a').removeClass("active-viewimg");
        jQuery(this).addClass("active-viewimg");
    });

    // product view js
    let activeImage = document.querySelector(".product-view-image .active");
    ...
    function changeImage(e) {
        if(typeof e.target.dataset != 'undefined'){
            activeImage.src = e.target.dataset.targetsource;
        } else {
    ...
    jQuery(".image-list img").on("click", changeImage);
    jQuery('a.toggle-nav').on('click', toggleNavigation);;
});
//product details page slider ends
