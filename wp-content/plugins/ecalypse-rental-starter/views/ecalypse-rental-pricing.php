								...
								<div class="row">
									<div class="col-md-11">
									  ...
									  <div class="form-group type-timerelated">
									    ...
									    <div class="col-sm-9">
									    	<a href="javascript:void(0);" id="ecalypse-rental-hour-range-box-show" class="btn btn-warning btn-xs"><?php _e('Setup the hour ranges', 'ecalypse-rental');?></a>
									  ...
									  <!-- Promo code //-->
									  <div class="form-group">
									    <label for="ecalypse-rental-promocode" class="col-sm-3 control-label">Promo code</label>
									    <div class="col-sm-9">
